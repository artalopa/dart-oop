...
class Student {
  ...
  Student({String? name = "ryan", int? age = 20, int? rollNumber = 1}) {
    this.name = name;
    this.age = age;
    this.rollNumber = rollNumber;
  }
...
void main() {
  Guru guru1 = Guru("Sutarta", 30, "Matematika", 50000);
  guru1.tampilkan();
  Guru guru2 = Guru("Maria", 35, "Bahasa Indonesia", 60000.0);
  guru2.tampilkan();

  Laptop laptop = Laptop();

  // Parameterized Constructor
  // Student student = Student("ryan", 20, 1);

  // Parameterized Constructor dengan Parameter Bernama
  // Student student = Student(name: "ryan", age: 20, rollNumber: 1);
